...
const Uploadpage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] pt-[80px] px-3 sm:px-10 pb-3 upload:flex upload:justify-evenly upload:items-center w-full">
      <div className="hidden upload:flex items-center justify-center relative w-[30rem] h-[30rem] rounded-xl overflow-hidden border-dashed border-2 border-gray-800">
        {selectedImage ? (
          <>
            <img
              src={selectedImage}
      ...
      <div className="flex flex-col bg-slate-500 w-full h-3/4 upload:w-2/5 p-5 mt-3 rounded-2xl items-center">
